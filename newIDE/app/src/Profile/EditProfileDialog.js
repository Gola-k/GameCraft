...
const EditProfileDialog = ({
  ...
  return (
    <I18n>
      {({ i18n }) => (
        <Dialog
          title={<Trans>Edit your GameCraft profile</Trans>}
          actions={actions}
          ...
          <Form onSubmit={edit} autoComplete="on" name="editProfile">
            <ColumnStackLayout noMargin>
              ...
              <TextField
                ...
                helperMarkdownText={i18n._(
                  t`Add your Discord username to get access to a dedicated channel if you have a Gold or Pro subscription! Join the [GameCraft Discord]().`
                )}
              />
              <TextField
                value={description}
                ...
                rows={3}
                rowsMax={5}
                translatableHintText={t`What are you using GameCraft for?`}
                onChange={(e, value) => {
              ...
              <Checkbox
                label={
                  <Trans>I want to receive the GameCraft Newsletter</Trans>
                }
