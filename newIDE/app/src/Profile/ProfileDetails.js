      ...
      try {
        ...
        if (
          ...
          showAlert({
            ...
            message: t`Ensure you don't have any typo in your username and that you have joined the GameCraft Discord server.`,
          });
          return;
        }
        showAlert({
              ...
              <Text color={!discordUsername ? 'secondary' : 'primary'}>
                {!discordUsername ? (
                  !canUserBenefitFromDiscordRole ? (
                    <MarkdownText
                      translatableSource={t`No discord username defined. Add it and get a Gold, Pro or Education subscription to claim your role on the [GameCraft Discord]().`}
                    />
                  ) : (
                    <MarkdownText
                      translatableSource={t`No discord username defined. Add it to claim your role on the [GameCraft Discord]().`}
                    />
                  )
                ) : (
                  <>
                    ...
                    {!canUserBenefitFromDiscordRole && (
                      <>
                        {' - '}
                        <MarkdownText
                          translatableSource={t`Get a Gold or Pro subscription to claim your role on the [GameCraft Discord]().`}
                        />
                      </>
                    )}
                  </>
