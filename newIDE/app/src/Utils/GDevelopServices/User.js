...
export const communityLinksConfig = {
  ...
  githubUsername: {
    ...
    getMessageFromUpdate: (responseCode: string) => {
      if (
        ...
        return {
          ...
          message: t`Thanks for starring GameCraft repository. We added credits to your account as a thank you gift.`,
        };
      } else if (responseCode === 'github-star/repository-not-starred') {
        return {
          title: t`We could not find your GitHub star`,
          message: t`Make sure you star the repository called GameCraft with your GitHub user and try again.`,
        };
      } else if (responseCode === 'github-star/user-not-found') {
        return {
          title: t`We could not find your GitHub user and star`,
          message: t`Make sure you create your GitHub account, star the repository called GameCraft, enter your username here and try again.`,
        };
      }
      return null;
    },
    getRewardMessage: (hasBadge: boolean, rewardValueInCredits: string) =>
      !hasBadge
        ? t`[Star the GameCraft repository](https://github.com/Gola-k/ClickEngineFinal) and add your GitHub username here to get ${rewardValueInCredits} free credits as a thank you!`
        : t`Thank you for supporting the GameCraft open-source community. Credits were added to your account as a thank you.`,
  },
  twitterUsername: {
    icon: <Twitter />,
    ...
    getMessageFromUpdate: (responseCode: string) => {
      if (
        ...
        return {
          title: t`You're awesome!`,
          message: t`Thanks for following GameCraft. We added credits to your account as a thank you gift.`,
        };
      } else if (responseCode === 'twitter-follow/account-not-followed') {
        return {
          title: t`We could not check your follow`,
          message: t`Make sure you follow the GameCraft account and try again.`,
        };
      } else if (responseCode === 'twitter-follow/user-not-found') {
        return {
          title: t`We could not find your user`,
          message: t`Make sure your username is correct, follow the GameCraft account and try again.`,
        };
      }
    ...
    getRewardMessage: (hasBadge: boolean, rewardValueInCredits: string) =>
      !hasBadge
        ? t`[Follow GameCraft]() and enter your Twitter username here to get ${rewardValueInCredits} free credits as a thank you!`
        : t`Thank you for supporting GameCraft. Credits were added to your account as a thank you.`,
  },
  facebookUsername: {
    icon: <Facebook />,
  ...
  tiktokUsername: {
    ...
    getRewardMessage: (hasBadge: boolean, rewardValueInCredits: string) =>
      !hasBadge
        ? t`[Follow GameCraft]() and enter your TikTok username here to get ${rewardValueInCredits} free credits as a thank you!`
        : t`Thank you for supporting GameCraft. Credits were added to your account as a thank you.`,
  },
  instagramUsername: {
    icon: <Instagram />,
