...
describe('Project service', () => {
  describe('extractDecodedFilenameFromProjectResourceUrl', () => {
    ...
    it('just extracts the filename from an URL which is not from GameCraft Cloud (or not valid)', () => {
      expect(
    ...
    it('just extracts the filename from an URL which is not from GameCraft Cloud, if encoded', () => {
      expect(
        extractDecodedFilenameFromProjectResourceUrl(
