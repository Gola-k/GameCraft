        ...
        {extensionShortHeader.tier === 'community' && (
          <AlertMessage kind="warning">
            <Trans>
              ...
              by the GameCraft extension team. As such, we can't guarantee it
              meets all the quality standards of official extensions. It could
              also not be compatible with older GameCraft versions. In case of
        ...
        {!isCompatible && (
          <AlertMessage kind="error">
            <Trans>
              ...
              GameCraft to work. Update GameCraft to be able to use this
