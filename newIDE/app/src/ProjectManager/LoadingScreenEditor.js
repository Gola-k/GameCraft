      ...
      {({ i18n }) => (
        <ColumnStackLayout expand noMargin>
            ...
            <ResponsiveLineStackLayout noMargin>
              <Column expand noMargin justifyContent="center">
                <Checkbox
                  label={
                    <Trans>
                      Display GameCraft logo at startup (in exported game)
                    </Trans>
                  }
              ...
              <Column expand noMargin justifyContent="center">
                <SelectField
                  fullWidth
                  floatingLabelText={<Trans>GameCraft logo style</Trans>}
          ...
          <SubscriptionChecker
            ...
            title={<Trans>Disable GameCraft splash at startup</Trans>}
          />
        </ColumnStackLayout>
      )}
    </I18n>
